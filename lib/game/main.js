...
MyGame = ig.Game.extend({
	...
	draw: function() {
		...
		} else if( this.ball.dead ) {
			this.font.draw( 'Press space', ig.system.width/2, 32, ig.Font.ALIGN.CENTER );
			this.font.draw( 'to reset ball!', ig.system.width/2, 40, ig.Font.ALIGN.CENTER );
		} else {
			this.parent();
		}
	}
