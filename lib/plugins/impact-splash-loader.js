...
ig.ImpactSplashLoader = ig.Loader.extend({
  ...
  run: function() { 
    ...
    ig.system.context.fillStyle = 'rgba(100,100,100,'+alpha+')';
  ...
  draw: function() {
    ...
    //var scorpion = new ig.Image( 'media/scorpion.png' );

    //scorpion.draw( ig.system.height / 2.7, ig.system.width / 80 );
    // Clear
    ...
    ctx.textAlign = 'right';
    ctx.font = '10px Arial';
    ctx.fillText( 'programming', w - 10, h - 10 );
    ctx.textAlign = 'left';
